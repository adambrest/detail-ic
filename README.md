...
The Redetailing list is in Smart order by default: anyone at risk of failing first, then firers a point or two short, then the rest by how close they are to Marksman. Each row says why it is listed. On Combat Shoot detail stages, firers whose own hits are below pass pace are tagged Weak and listed under Redetailing; Build detail puts one of them with the strongest shooters available (those who still need the stage first, then those who have cleared it) and shows the expected average before you create it.
